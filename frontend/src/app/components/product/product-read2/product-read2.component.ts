...
export class ProductRead2Component implements AfterViewInit, OnInit {
  // Percorre o html do componente e atribui o primeiro elemento do tipo encontrado(ex: MatPaginator) ao atributo paginator
  ...
  // Instancia o datasource na criaçao o componente
  ngOnInit() {
